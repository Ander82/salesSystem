...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "pedro", "pedro@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "ivo", "ivro@gmail.com", new DateTime(1985, 7, 29), 1050.0, d2);
            Seller s3 = new Seller(3, "luco", "pektr@gmail.com", new DateTime(1999, 4, 21), 5000.0, d3);
            Seller s4 = new Seller(4, "nikao", "nika@gmail.com", new DateTime(2005, 1, 11), 2000.0, d4);
            Seller s5 = new Seller(5, "zeca", "zaca@gmail.com", new DateTime(1998, 4, 21), 2500.0, d2);
            Seller s6 = new Seller(6, "noeh", "noeh@gmail.com", new DateTime(1995, 9, 05), 3300.0, d3);
